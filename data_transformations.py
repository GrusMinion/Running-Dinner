...
class DataTransformer():
    def __init__(self, bewoners_df, adressen_df, bijelkaar_df,
                 buren_df, gang_vorigjaar_df, tafelgenoot_vorigjaar_df,
                 oplossing_df=None, gangen=['Voor', 'Hoofd', 'Na']):
        ...
        # KPIs corresponding to penalty 0
        ...
        self.table_KPI = pd.DataFrame()  # Initialize the table_KPI here

        # Only calculate penalties if oplossing_df is provided
        if self.oplossing_df is not None:
            self.calculate_penalties()

    def add_oplossing_df(self, oplossing_df):
        """Allows adding a new oplossing_df after initialization,
            e.g., when a schedule is created."""
        self.oplossing_df = oplossing_df
        # Recalculate penalties and KPIs after adding the oplossing_df
        self.calculate_penalties()     

    def calculate_penalties(self):
        """Calculates all the penalties based on oplossing_df."""
        self.penalty0()
        self.penalty1()
        self.penalty2()
        self.penalty3()
